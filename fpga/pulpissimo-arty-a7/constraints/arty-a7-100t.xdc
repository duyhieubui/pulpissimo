...
## A7-100T does not have this
## Sys clock
# set_property -dict {PACKAGE_PIN AD11 IOSTANDARD LVDS} [get_ports ref_clk_n]
set_property -dict {PACKAGE_PIN E3 IOSTANDARD LVCMOS33} [get_ports ref_clk_p]


## Buttons
set_property -dict {PACKAGE_PIN C2 IOSTANDARD LVCMOS33} [get_ports pad_reset_n]

set_property -dict {PACKAGE_PIN C10 IOSTANDARD LVCMOS33} [get_ports btnc_i]
...
## To use FTDI FT2232 JTAG #mapping to JA
set_property -dict {PACKAGE_PIN G13 IOSTANDARD LVCMOS33} [get_ports pad_jtag_trst]
set_property -dict {PACKAGE_PIN B11 IOSTANDARD LVCMOS33} [get_ports pad_jtag_tck]
set_property -dict {PACKAGE_PIN A11 IOSTANDARD LVCMOS33} [get_ports pad_jtag_tdi]
set_property -dict {PACKAGE_PIN D12 IOSTANDARD LVCMOS33} [get_ports pad_jtag_tdo]
set_property -dict {PACKAGE_PIN D13 IOSTANDARD LVCMOS33} [get_ports pad_jtag_tms]
...
## Switches
set_property -dict {PACKAGE_PIN A8 IOSTANDARD LVCMOS33} [get_ports switch0_i]
set_property -dict {PACKAGE_PIN C11 IOSTANDARD LVCMOS33} [get_ports switch1_i]
...
set_property -dict {PACKAGE_PIN K17 IOSTANDARD LVCMOS33} [get_ports { pad_spim_sdio0 }]; #IO_L1P_T0_D00_MOSI_14 Sch=qspi_d[0]
...
## OLED Display #jb
set_property -dict {PACKAGE_PIN E15 IOSTANDARD LVCMOS33} [get_ports oled_dc_o]
set_property -dict {PACKAGE_PIN E16 IOSTANDARD LVCMOS33} [get_ports oled_rst_o]
set_property -dict {PACKAGE_PIN D15 IOSTANDARD LVCMOS33} [get_ports oled_spim_sck_o]
set_property -dict {PACKAGE_PIN C15 IOSTANDARD LVCMOS33} [get_ports oled_spim_mosi_o]
set_property -dict {PACKAGE_PIN J17 IOSTANDARD LVCMOS33} [get_ports oled_vbat_o]
set_property -dict {PACKAGE_PIN J18 IOSTANDARD LVCMOS33} [get_ports oled_vdd_o]
...
set_property -dict {PACKAGE_PIN D4 IOSTANDARD LVCMOS33} [get_ports pad_sdio_cmd]
set_property -dict {PACKAGE_PIN D3 IOSTANDARD LVCMOS33} [get_ports pad_sdio_data0]
set_property -dict {PACKAGE_PIN F4 IOSTANDARD LVCMOS33} [get_ports pad_sdio_data1]
set_property -dict {PACKAGE_PIN F3 IOSTANDARD LVCMOS33} [get_ports pad_sdio_data2]
set_property -dict {PACKAGE_PIN E2 IOSTANDARD LVCMOS33} [get_ports pad_sdio_data3]
set_property -dict {PACKAGE_PIN D2 IOSTANDARD LVCMOS33} [get_ports sdio_reset_o]
set_property -dict {PACKAGE_PIN H2 IOSTANDARD LVCMOS33} [get_ports pad_sdio_clk]
